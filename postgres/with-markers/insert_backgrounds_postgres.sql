INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Acolyte', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 127, true, true, '## Feature: Shelter of the Faithful
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Anthropologist', (SELECT id FROM sources WHERE name ILIKE 'ToA'), 191, false, false, '## Cultural Chameleon
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Archaeologist', (SELECT id FROM sources WHERE name ILIKE 'ToA'), 192, false, false, '## Dust Digger
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist'), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist'), (SELECT id FROM tools WHERE name ILIKE 'cartographer''s tools'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ashari', (SELECT id FROM sources WHERE name ILIKE 'TDCSR'), 180, false, false, '## Feature: Elemental Harmony
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM skills WHERE name ILIKE 'survival'), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM languages WHERE name ILIKE 'aquan'), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM languages WHERE name ILIKE 'auran'), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM languages WHERE name ILIKE 'ignan'), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM languages WHERE name ILIKE 'terran'), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Astral Drifter', (SELECT id FROM sources WHERE name ILIKE 'AAG'), 7, false, false, '## Longevity
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Athlete', (SELECT id FROM sources WHERE name ILIKE 'MOT'), 31, false, false, '## Feature: Echoes of Victory
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete'), (SELECT id FROM skills WHERE name ILIKE 'acrobatics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

-- Augen Trust (Spy) is a copy of Variant Criminal (Spy) and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Azorius Functionary', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 33, false, false, '## Feature: Legal Authority
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary'), 2);
...
INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Black Fist Double Agent', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 2, false, false, '## Lifestyle
Moderate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Boros Legionnaire', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 40, false, false, '## Feature: Legion Station
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM languages WHERE name ILIKE 'celestial'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM languages WHERE name ILIKE 'draconic'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM languages WHERE name ILIKE 'goblin'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM languages WHERE name ILIKE 'other'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Caravan Specialist', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil'), 2, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Celebrity Adventurer''s Scion', (SELECT id FROM sources WHERE name ILIKE 'AI'), 48, false, false, '## Feature: Name Dropping
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion'), 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Charlatan', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 128, false, false, '## Feature: False Identity
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('City Watch', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 145, false, false, '## Feature: Watcher''s Eye
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Clan Crafter', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 145, false, false, '## Feature: Respect of the Stout Folk
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter'), (SELECT id FROM languages WHERE name ILIKE 'dwarvish'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Clasp Member', (SELECT id FROM sources WHERE name ILIKE 'TDCSR'), 181, false, false, '## Feature: A Favor in Turn
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM languages WHERE name ILIKE 'thieves'' cant'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Cloistered Scholar', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 146, false, false, '## Feature: Library Access
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar'), (SELECT id FROM skills WHERE name ILIKE 'nature'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar'), 2);

-- Cobalt Scholar (Sage) is a copy of Sage and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Cormanthor Refugee', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 5, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Courtier', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 146, false, false, '## Feature: Court Functionary
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Criminal', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 129, false, true, '## Feature: Criminal Contact
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Custom Background', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 126, false, false, '## Feature: Choose a Feature
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Custom Background'), (SELECT id FROM skills WHERE name ILIKE 'any'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Custom Background'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Dimir Operative', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 46, false, false, '## Feature: False Identity
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Dragon Casualty', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 3, false, false, '## Lifestyle
Wretched
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM languages WHERE name ILIKE 'draconic'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Earthspur Miner', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil'), 3, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner'), (SELECT id FROM languages WHERE name ILIKE 'dwarvish'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner'), (SELECT id FROM languages WHERE name ILIKE 'undercommon'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Entertainer', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 130, false, false, '## Feature: By Popular Demand
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer'), (SELECT id FROM skills WHERE name ILIKE 'acrobatics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Faceless', (SELECT id FROM sources WHERE name ILIKE 'BGDIA'), 203, false, false, '## Faceless Persona
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Faction Agent', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 147, false, false, '## Feature: Safe Haven
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'deception'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'history'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'medicine'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'nature'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'perception'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'performance'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), (SELECT id FROM skills WHERE name ILIKE 'survival'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Failed Merchant', (SELECT id FROM sources WHERE name ILIKE 'AI'), 49, false, false, '## Feature: Supply Chain
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Far Traveler', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 148, false, false, '## Feature: All Eyes on You
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Feylost', (SELECT id FROM sources WHERE name ILIKE 'WBtW'), 9, false, false, '## Feature: Feywild Connection
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Fisher', (SELECT id FROM sources WHERE name ILIKE 'GoS'), 29, false, false, '## Feature: Harvest the Water
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher'), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Folk Hero', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 131, false, true, '## Feature: Rustic Hospitality
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gambler', (SELECT id FROM sources WHERE name ILIKE 'AI'), 49, false, false, '## Feature: Never Tell Me the Odds
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gate Urchin', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 6, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gate Warden', (SELECT id FROM sources WHERE name ILIKE 'SatO'), 7, false, false, '## Feature: Planar Infusion
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Giant Foundling', (SELECT id FROM sources WHERE name ILIKE 'BGG'), 6, false, false, '## Origin Stories
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling'), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Golgari Agent', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 53, false, false, '## Feature: Undercity Paths
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM languages WHERE name ILIKE 'elvish'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM languages WHERE name ILIKE 'giant'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM languages WHERE name ILIKE 'other'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent'), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Grinner', (SELECT id FROM sources WHERE name ILIKE 'EGW'), 200, false, false, '## Feature: Ballad of the Grinning Fool
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gruul Anarch', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 60, false, false, '## Feature: Rubblebelt Refuge
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM languages WHERE name ILIKE 'draconic'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM languages WHERE name ILIKE 'giant'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM languages WHERE name ILIKE 'goblin'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM languages WHERE name ILIKE 'sylvan'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Guild Artisan', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 132, false, false, '## Feature: Guild Membership
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Harborfolk', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil'), 4, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Haunted One', (SELECT id FROM sources WHERE name ILIKE 'VRGR'), 34, false, false, '## Feature: Heart of Darkness
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One'), (SELECT id FROM skills WHERE name ILIKE 'survival'), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One'), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hermit', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 134, false, false, '## Feature: Discovery
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit'), (SELECT id FROM skills WHERE name ILIKE 'medicine'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hillsfar Merchant', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 7, false, false, '## Lifestyle
Wealthy
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hillsfar Smuggler', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 8, false, false, '## Lifestyle
Modest
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('House Agent', (SELECT id FROM sources WHERE name ILIKE 'ERLW'), 53, false, false, '| Your House | Proficiencies |
|---|---|
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'tinker''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'brewer''s supplies'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'cook''s utensils'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'tinker''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (air)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'calligrapher''s supplies'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent'), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit'), FALSE);
...
INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Inheritor', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 150, false, false, '## Feature: Inheritance
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), (SELECT id FROM skills WHERE name ILIKE 'history'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Initiate', (SELECT id FROM sources WHERE name ILIKE 'PSA'), 8, false, false, '## Feature: Trials of the Five Gods
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

-- Initiate (Dissenter) is a copy of Initiate and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Inquisitor', (SELECT id FROM sources WHERE name ILIKE 'PSI'), 12, false, false, '## Feature: Legal Authority
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Investigator', (SELECT id FROM sources WHERE name ILIKE 'VRGR'), 35, false, false, '## Feature: Official Inquiry
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator'), (SELECT id FROM skills WHERE name ILIKE 'insight'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator'), (SELECT id FROM skills WHERE name ILIKE 'perception'), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Iron Route Bandit', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 5, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Izzet Engineer', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 66, false, false, '## Feature: Urban Infrastructure
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM languages WHERE name ILIKE 'draconic'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM languages WHERE name ILIKE 'goblin'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM languages WHERE name ILIKE 'other'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Knight of Solamnia', (SELECT id FROM sources WHERE name ILIKE 'DSotDQ'), 30, false, false, '## Feature: Squire of Solamnia
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Knight of the Order', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 151, false, false, '## Feature: Knightly Regard
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM skills WHERE name ILIKE 'history'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM skills WHERE name ILIKE 'nature'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Lorehold Student', (SELECT id FROM sources WHERE name ILIKE 'SCC'), 31, false, false, '## Feature: Lorehold Initiate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student'), 2);

-- Luxonborn (Acolyte) is a copy of Acolyte and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Lyceum Scholar', (SELECT id FROM sources WHERE name ILIKE 'TDCSR'), 183, false, false, '## Feature: Academic Requisition
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar'), (SELECT id FROM skills WHERE name ILIKE 'history'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar'), (SELECT id FROM languages WHERE name ILIKE 'any'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mage of High Sorcery', (SELECT id FROM sources WHERE name ILIKE 'DSotDQ'), 30, false, false, '## Feature: Initiate of High Sorcery
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Marine', (SELECT id FROM sources WHERE name ILIKE 'GoS'), 31, false, false, '## Feature: Steady
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mercenary Veteran', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 152, false, false, '## Feature: Mercenary Life
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mulmaster Aristocrat', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil'), 5, false, false, '## Lifestyle
Wealthy
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

-- Myriad Operative (Criminal) is a copy of Criminal and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Noble', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 135, false, true, '## Feature: Position of Privilege
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Orzhov Representative', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 72, false, false, '## Feature: Leverage
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Outlander', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 136, false, false, '## Feature: Wanderer
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Phlan Insurgent', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 6, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Phlan Refugee', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil'), 6, false, false, '## Lifestyle
Modest
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Plaintiff', (SELECT id FROM sources WHERE name ILIKE 'AI'), 50, false, false, '## Feature: Legalese
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff'), (SELECT id FROM skills WHERE name ILIKE 'medicine'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Planar Philosopher', (SELECT id FROM sources WHERE name ILIKE 'SatO'), 8, false, false, '| Faction | Skill |
|---|---|
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'religion'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'insight'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'nature'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'history'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'perception'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'medicine'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'survival'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'performance'), TRUE, undefined);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Prismari Student', (SELECT id FROM sources WHERE name ILIKE 'SCC'), 32, false, false, '## Feature: Prismari Initiate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student'), (SELECT id FROM skills WHERE name ILIKE 'acrobatics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Quandrix Student', (SELECT id FROM sources WHERE name ILIKE 'SCC'), 33, false, false, '## Feature: Quandrix Initiate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rakdos Cultist', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 79, false, false, '## A Flair for the Dramatic
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist'), (SELECT id FROM skills WHERE name ILIKE 'acrobatics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist'), (SELECT id FROM languages WHERE name ILIKE 'abyssal'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist'), (SELECT id FROM languages WHERE name ILIKE 'giant'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Reformed Cultist', (SELECT id FROM sources WHERE name ILIKE 'TDCSR'), 185, false, false, '## Feature: Fell Teachings
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist'), (SELECT id FROM languages WHERE name ILIKE 'any'), FALSE);

-- Revelry Pirate (Sailor) is a copy of Sailor and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rewarded', (SELECT id FROM sources WHERE name ILIKE 'BMT'), 57, false, false, '## Feature: Fortune''s Favor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rival Intern', (SELECT id FROM sources WHERE name ILIKE 'AI'), 51, false, false, '## Feature: Inside Informant
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ruined', (SELECT id FROM sources WHERE name ILIKE 'BMT'), 58, false, false, '## Feature: Still Standing
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rune Carver', (SELECT id FROM sources WHERE name ILIKE 'BGG'), 12, false, false, '## Rune Styles
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver'), (SELECT id FROM languages WHERE name ILIKE 'giant'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Sage', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 137, false, true, '## Feature: Researcher
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Sailor', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 139, false, false, '## Feature: Ship''s Passage
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor'), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Secret Identity', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 9, false, false, '## Lifestyle
Modest
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Selesnya Initiate', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 86, false, false, '## Feature: Conclave''s Shelter
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM languages WHERE name ILIKE 'elvish'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM languages WHERE name ILIKE 'other'), TRUE, undefined);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM languages WHERE name ILIKE 'sylvan'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Shade Fanatic', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 10, false, false, '## Lifestyle
Modest
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic'), (SELECT id FROM languages WHERE name ILIKE 'other'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic'), (SELECT id FROM tools WHERE name ILIKE 'forgery kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Shipwright', (SELECT id FROM sources WHERE name ILIKE 'GoS'), 33, false, false, '## Feature: I''ll Patch It!
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright'), (SELECT id FROM tools WHERE name ILIKE 'carpenter''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Silverquill Student', (SELECT id FROM sources WHERE name ILIKE 'SCC'), 35, false, false, '## Feature: Silverquill Initiate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Simic Scientist', (SELECT id FROM sources WHERE name ILIKE 'GGR'), 93, false, false, '## Clades and Projects
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist'), (SELECT id FROM skills WHERE name ILIKE 'arcana'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist'), (SELECT id FROM skills WHERE name ILIKE 'medicine'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist'), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Smuggler', (SELECT id FROM sources WHERE name ILIKE 'GoS'), 34, false, false, '## Feature: Down Low
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Soldier', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 140, false, true, '## Feature: Military Rank
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier'), (SELECT id FROM skills WHERE name ILIKE 'intimidation'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Stojanow Prisoner', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 8, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner'), (SELECT id FROM skills WHERE name ILIKE 'perception'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner'), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ticklebelly Nomad', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd'), 9, false, false, '## Lifestyle
Poor
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad'), (SELECT id FROM skills WHERE name ILIKE 'animal handling'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad'), (SELECT id FROM languages WHERE name ILIKE 'giant'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Trade Sheriff', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons'), 11, false, false, '## Lifestyle
Modest
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff'), (SELECT id FROM languages WHERE name ILIKE 'elvish'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Urban Bounty Hunter', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 153, false, false, '## Feature: Ear to the Ground
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM skills WHERE name ILIKE 'deception'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM skills WHERE name ILIKE 'insight'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), TRUE, 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Urchin', (SELECT id FROM sources WHERE name ILIKE 'PHB'), 141, false, false, '## Feature: City Secrets
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin'), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Uthgardt Tribe Member', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 153, false, false, '## Feature: Uthgardt Heritage
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Variant City Watch (Investigator)', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 145, false, false, '## Feature: Watcher''s Eye
Your experience in enforcing the law, and dealing with lawbreakers, gives you a feel for local laws and criminals. You can easily find the local outpost of the watch or a similar organization, and just as easily pick out the dens of criminal activity in a community, although you''re more likely to be welcome in the former locations rather than the latter.
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)'), (SELECT id FROM skills WHERE name ILIKE 'insight'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)'), (SELECT id FROM skills WHERE name ILIKE 'investigation'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)'), 2);
...
INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Vizier', (SELECT id FROM sources WHERE name ILIKE 'PSA'), 10, false, false, '## Feature: Voice of Authority
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier'), (SELECT id FROM skills WHERE name ILIKE 'religion'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier'), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier'), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument'), FALSE);

-- Vizier (Dissenter) is a copy of Vizier and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Volstrucker Agent', (SELECT id FROM sources WHERE name ILIKE 'EGW'), 202, false, false, '## Feature: Shadow Network
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent'), (SELECT id FROM skills WHERE name ILIKE 'deception'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent'), (SELECT id FROM skills WHERE name ILIKE 'stealth'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent'), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Waterdhavian Noble', (SELECT id FROM sources WHERE name ILIKE 'SCAG'), 154, false, false, '## Feature: Kept in Style
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble'), (SELECT id FROM skills WHERE name ILIKE 'history'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble'), (SELECT id FROM skills WHERE name ILIKE 'persuasion'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble'), (SELECT id FROM tools WHERE name ILIKE 'gaming set'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Whitestone Rifle Corps', (SELECT id FROM sources WHERE name ILIKE 'TDCSR'), 187, false, false, '## Feature: Legacy of Secrecy
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps'), (SELECT id FROM skills WHERE name ILIKE 'perception'), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps'), (SELECT id FROM skills WHERE name ILIKE 'survival'), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps'), (SELECT id FROM languages WHERE name ILIKE 'any'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Wildspacer', (SELECT id FROM sources WHERE name ILIKE 'AAG'), 8, false, false, '## Close Encounter
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer'), (SELECT id FROM skills WHERE name ILIKE 'athletics'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer'), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools'), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer'), (SELECT id FROM tools WHERE name ILIKE 'vehicles (space)'), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Witchlight Hand', (SELECT id FROM sources WHERE name ILIKE 'WBtW'), 11, false, false, '## Feature: Carnival Fixture
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand'), (SELECT id FROM skills WHERE name ILIKE 'performance'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand'), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand'), (SELECT id FROM tools WHERE name ILIKE 'disguise kit'), TRUE, undefined);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand'), (SELECT id FROM tools WHERE name ILIKE 'musical instrument'), TRUE, undefined);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Witherbloom Student', (SELECT id FROM sources WHERE name ILIKE 'SCC'), 36, false, false, '## Feature: Witherbloom Initiate
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student'), (SELECT id FROM skills WHERE name ILIKE 'nature'), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student'), (SELECT id FROM skills WHERE name ILIKE 'survival'), FALSE);

INSERT INTO background_language_proficiencies (background_id, any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student'), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student'), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit'), FALSE);