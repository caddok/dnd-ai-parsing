INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Acolyte', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 127, true, true, '## Feature: Shelter of the Faithful
...
| 6 | Once I pick a goal, I become obsessed with it to the detriment of everything else in my life. |', '[{"_":[{"item":"holy symbol|phb","displayName":"holy symbol (a gift to you when you entered the priesthood)"},{"special":"sticks of incense","quantity":5},{"special":"vestments"},"common clothes|phb",{"item":"pouch|phb","containsValue":1500}]},{"a":[{"item":"book|phb","displayName":"prayer book"}],"b":[{"special":"prayer wheel"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Acolyte' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Anthropologist', (SELECT id FROM sources WHERE name ILIKE 'ToA' LIMIT 1), 191, false, false, '## Cultural Chameleon
...
| 6 | I wear a tribal mask and never take it off. |', '[{"_":[{"special":"leather-bound diary"},"ink (1-ounce bottle)|phb","ink pen|phb","traveler''s clothes|phb",{"item":"trinket|phb","displayName":"trinket of special significance"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Anthropologist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Archaeologist', (SELECT id FROM sources WHERE name ILIKE 'ToA' LIMIT 1), 192, false, false, '## Dust Digger
...
| d8 | Item |
|---|---|
| 1 | {@item pole (10-foot)|phb|10-foot pole} |
| 2 | {@item Crowbar|phb} |
| 3 | Hat |
| 4 | {@item Hooded lantern|phb} |
| 5 | Medallion |
| 6 | {@item Shovel|phb} |
| 7 | {@item Sledgehammer|phb} |
| 8 | {@item Whip|phb} |
...
| 6 | I can''t sleep except in total darkness. |', '[{"_":[{"item":"map or scroll case|phb","displayName":"wooden case containing a map to a ruin or dungeon"},"bullseye lantern|phb","miner''s pick|phb","traveler''s clothes|phb","shovel|phb","two-person tent|phb",{"item":"trinket|phb","displayName":"trinket recovered from a dig site"},{"item":"pouch|phb","containsValue":2500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Archaeologist' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'cartographer''s tools' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ashari', (SELECT id FROM sources WHERE name ILIKE 'TDCSR' LIMIT 1), 180, false, false, '## Feature: Elemental Harmony
...
| {@dice d6} | Ideal |
|---|---|
| 1 | {@b Destiny}. I believe that everyone has a role to play. Now I just have to find mine. (Neutral) |
| 2 | {@b Community}. It''s important to surround yourself with people you can count on, and who will support you. (Good) |
| 3 | {@b Knowledge}. I want to learn everything I can about the Elemental Planes—and maybe even visit them myself. (Neutral) |
| 4 | {@b Freedom}. I don''t care what anyone says. Even if it causes problems, the elements must be free. And so should I. (Chaotic) |
| 5 | {@b Structure}. The elements are in harmony when they are free to act as they will, within the safe boundaries set by {@book the Ashari|TDCSR|2|The Ashari}. People are much the same. (Lawful) |
| 6 | {@b Virtuous Cycle}. If I see someone who needs help, I feel compelled to assist them. Surely they''ll return the favor someday! (Good) |
| {@dice d6} | Bond |
|---|---|
...
| 5 | When I was a baby, a {@creature giant eagle} brought me to {@book Zephrah|TDCSR|3|Zephrah}. I love my family, but I often wonder who my birth parents are. |
...
| 6 | Ugh, I know it''s not right, but I can''t help but look down on people who can''t manipulate the elements. It''s not like it''s hard! |', '[{"_":[{"item":"Traveler''s Clothes|phb","displayName":"A set of traveler''s clothes"},{"special":"a staff carved with symbols of your tribe"},"herbalism kit|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'aquan' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'auran' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'ignan' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'terran' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ashari' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Astral Drifter', (SELECT id FROM sources WHERE name ILIKE 'AAG' LIMIT 1), 7, false, false, '## Longevity
...
| 10 | Ptah, god of knowledge and secrets (lawful neutral) |', '[{"_":["traveler''s clothes|phb",{"special":"diary"},"ink pen|phb","ink (1-ounce bottle)|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Astral Drifter' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Athlete', (SELECT id FROM sources WHERE name ILIKE 'MOT' LIMIT 1), 31, false, false, '## Feature: Echoes of Victory
...
| 6 | I must be the captain of any group I join. |', '[{"a":[{"special":"bronze discus"}],"b":[{"special":"leather ball"}]},{"a":[{"special":"lucky charm"}],"b":[{"special":"past trophy"}]},{"_":["traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'acrobatics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Athlete' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

-- Augen Trust (Spy) is a copy of Variant Criminal (Spy) and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Azorius Functionary', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 33, false, false, '## Feature: Legal Authority
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell friends}, {@spell message} |
| 1st | {@spell command}, {@spell ensnaring strike} |
| 2nd | {@spell arcane lock}, {@spell calm emotions}, {@spell hold person} |
| 3rd | {@spell clairvoyance}, {@spell counterspell} |
| 4th | {@spell compulsion}, {@spell divination} |
| 5th | {@spell dominate person} |
...
| d6 | Ideal |
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Order}. The law is meant to ensure that the gears of society turn smoothly and quietly. (Lawful) |
| 3 | {@b Peace}. The ultimate object of the law is to remove violence from society. (Good) |
| 4 | {@b Compliance}. Coercion is a fine way of ensuring that the laws are obeyed. (Lawful) |
| 5 | {@b Legislation}. The law embodies excellence in its precision and detail. (Lawful) |
| 6 | {@b Punishment}. A public display of consequences is an excellent deterrent for other criminals. (Evil) |
| d6 | Bond |
|---|---|
...
An Azorius soldier or lawmage is a force for order, charged with fighting crime on the streets—and in the halls of power. You might spend your time foiling thefts, putting a stop to Orzhov extortion, rooting out Dimir spies, or hunting down Golgari assassins. Perhaps you take your orders from a precognitive mage (or you are one yourself) who receives unpredictable and cryptic visions of future crimes that you and your allies must try to prevent.', '[{"_":[{"special":"Azorius insignia"},{"special":"scroll containing the text of a law important to you"},"ink (1-ounce bottle)|phb","ink pen|phb","fine clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Azorius Functionary' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

-- Baldur''s Gate Acolyte is a copy of Acolyte and is handled manually or by another script.

-- Baldur''s Gate Charlatan is a copy of Charlatan and is handled manually or by another script.

-- Baldur''s Gate Criminal is a copy of Criminal and is handled manually or by another script.

-- Baldur''s Gate Entertainer is a copy of Entertainer and is handled manually or by another script.

-- Baldur''s Gate Folk Hero is a copy of Folk Hero and is handled manually or by another script.

-- Baldur''s Gate Guild Artisan is a copy of Guild Artisan and is handled manually or by another script.

-- Baldur''s Gate Hermit is a copy of Hermit and is handled manually or by another script.

-- Baldur''s Gate Noble is a copy of Noble and is handled manually or by another script.

-- Baldur''s Gate Outlander is a copy of Outlander and is handled manually or by another script.

-- Baldur''s Gate Sage is a copy of Sage and is handled manually or by another script.

-- Baldur''s Gate Sailor is a copy of Sailor and is handled manually or by another script.

-- Baldur''s Gate Soldier is a copy of Soldier and is handled manually or by another script.

-- Baldur''s Gate Urchin is a copy of Urchin and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Black Fist Double Agent', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 2, false, false, '## Lifestyle
Moderate
...
| 6 | I am spendthrift, and share my wealth with the patrons of my favorite tavern. |', '[{"_":["disguise kit|phb","common clothes|phb",{"item":"emblem|phb","displayName":"Tears of Virulence emblem"},{"special":"writ of free agency signed by the Lord Regent"},{"item":"pouch|phb","containsValue":1500}]},{"a":[{"equipmentType":"toolArtisan"}],"b":[{"equipmentType":"setGaming"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Black Fist Double Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Boros Legionnaire', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 40, false, false, '## Feature: Legion Station
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell fire bolt}, {@spell sacred flame} |
| 1st | {@spell guiding bolt}, {@spell heroism} |
| 2nd | {@spell aid}, {@spell scorching ray} |
| 3rd | {@spell beacon of hope}, {@spell blinding smite} |
| 4th | {@spell death ward}, {@spell wall of fire} |
| 5th | {@spell flame strike} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Justice}. Achieving justice requires establishing fair, equitable, and compassionate relationships within a community. (Good) |
| 3 | {@b Protection}. It isn''t right for innocents to suffer because of the arrogance of the powerful. (Good) |
| 4 | {@b Solidarity}. It is most crucial to act with a single will, marching side by side in perfect accord. (Lawful) |
| 5 | {@b Order}. Society functions only if people do their duty and respect the chain of command. (Lawful) |
| 6 | {@b Conviction}. Anything worth doing is worth doing with your whole heart. (Lawful) |
| d6 | Bond |
|---|---|
...
| 3 | A close friend serves aboard the {@i Parhelion II}, a flying fortress. |
...
Tajic is a firefist who carries the exalted title of Blade of the Legion, putting him just below the angels in rank. He maintains close communication with Aurelia, though recent events in the city have set them at odds. Tajic believes that the Boros can trust only the Boros. He is convinced that any effort at peace among the guilds is doomed to failure without the Guildpact. The Boros, he argues, would be better off spending their energy to make themselves stronger so they can uphold the fragile balance that exists now—and protect the innocent when the balance tilts. Aurelia feels that his negative attitude runs the risk of poisoning the hearts of the other Boros and undermining any peace efforts. For the most part, in deference to the angel, Tajic keeps his views to himself.', '[{"_":[{"special":"Boros insignia"},{"special":"feather from an angel''s wing"},{"special":"tattered piece of a Boros banner (a souvenir from a famous battle)"},"common clothes|phb",{"item":"pouch|phb","containsValue":200}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'celestial' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'draconic' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'goblin' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'other' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Boros Legionnaire' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Caravan Specialist', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil' LIMIT 1), 2, false, false, '## Lifestyle
Poor
...
| 6 | I like to explore, and my curiosity will sometimes get me into trouble. |', '[{"_":["whip|phb","two-person tent|phb",{"special":"regional map"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Caravan Specialist' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Celebrity Adventurer''s Scion', (SELECT id FROM sources WHERE name ILIKE 'AI' LIMIT 1), 48, false, false, '## Feature: Name Dropping
...
| 6 | You have to look out for yourself. No one else will. |', '[{"_":["disguise kit|phb","fine clothes|phb",{"item":"pouch|phb","containsValue":3000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Celebrity Adventurer''s Scion' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Charlatan', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 128, false, false, '## Feature: False Identity
...
| 6 | I hate to admit it and will hate myself for it, but I''ll run and preserve my own hide if the going gets tough. |', '[{"_":["fine clothes|phb","disguise kit|phb",{"item":"pouch|phb","containsValue":1500}]},{"a":[{"special":"stoppered bottles filled with colored liquid","quantity":10}],"b":[{"special":"set of weighted dice"}],"c":[{"special":"deck of marked cards"}],"d":[{"special":"signet ring of an imaginary duke"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Charlatan' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('City Watch', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 145, false, false, '## Feature: Watcher''s Eye
...
Your bond is likely associated with your fellow watch members or the watch organization itself and almost certainly concerns your community. Your ideal probably involves the fostering of peace and safety. An investigator is likely to have an ideal connected to achieving justice by successfully solving crimes.', '[{"_":[{"special":"uniform in the style of your unit and indicative of your rank"},{"item":"horn|phb","displayName":"horn with which to summon help"},{"item":"manacles|phb","displayName":"set of manacles"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'City Watch' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Clan Crafter', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 145, false, false, '## Feature: Respect of the Stout Folk
...
Your bond is almost certainly related to the master or the clan that taught you, or else to the work that you produce. Your ideal might have to do with maintaining the high quality of your work or preserving the dwarven traditions of craftsmanship.', '[{"_":[{"equipmentType":"toolArtisan"},{"special":"maker''s mark chisel used to mark your handiwork with the symbol of the clan of crafters you learned your skill from"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'dwarvish' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clan Crafter' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Clasp Member', (SELECT id FROM sources WHERE name ILIKE 'TDCSR' LIMIT 1), 181, false, false, '## Feature: A Favor in Turn
...
| {@dice d6} | Ideal |
|---|---|
| 1 | {@b By Any Means}. I complete jobs. Collateral damage isn''t my problem. (Chaotic) |
| 2 | {@b Ambition}. I will climb to the top of the ladder. Everything I do is a stepping-stone to a Spireling''s position. (Neutral) |
| 3 | {@b Decisiveness}. It''s important to make up your mind so you can act swiftly and without delay. (Neutral) |
| 4 | {@b Honor}. There''s room in the {@book Clasp|TDCSR|2|The Clasp} for both good and evil. Every day, I awake and choose to do what''s right. (Good) |
| 5 | {@b Family}. The {@book Clasp|TDCSR|2|The Clasp} is family. Anything that''s good for the family is good for me. (Lawful) |
| 6 | {@b Self-Interest}. There are too many bleeding hearts in the {@book Clasp|TDCSR|2|The Clasp} these days. Doing the right thing means doing the thing that makes my life better. (Evil) |
| {@dice d6} | Bond |
|---|---|
...
| 3 | I was inspired to join the {@book Clasp|TDCSR|2|The Clasp} by the stories my parents told of being saved from the {@book Chroma Conclave''s|TDCSR|1|The Chroma Conclave} attack on {@book Emon|TDCSR|3|Emon, the City of Fellowship}. I can look past the organization''s flaws. |
| 4 | I was nearly killed by the {@book Myriad|TDCSR|2|The Myriad}. If the {@book Clasp|TDCSR|2|The Clasp} is the enemy of those villains, then the {@book Clasp|TDCSR|2|The Clasp} is my friend. |
...
| 6 | I joined the {@book Clasp|TDCSR|2|The Clasp} to become rich, powerful, and beloved. That''s all there is to it. |
| {@dice d6} | Flaw |
|---|---|
...
| 5 | I can''t work with shoddy, makeshift {@item thieves'' tools|PHB}. I need everything involving my work to be perfect. |
| 6 | Any slight against me, no matter how small, is cause for revenge. |', '[{"_":[{"item":"common clothes|phb","displayName":"A set of inconspicuous common clothes"},{"equipmentType":"toolArtisan"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'thieves'' cant' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Clasp Member' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Cloistered Scholar', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 146, false, false, '## Feature: Library Access
...
Your bond is almost certainly associated either with the place where you grew up or with the knowledge you hope to acquire through adventuring. Your ideal is no doubt related to how you view the quest for knowledge and truth - perhaps as a worthy goal in itself, or maybe as a means to a desirable end.', '[{"_":[{"item":"robes|phb","displayName":"The scholar''s robes of your cloister"},"pouch|phb",{"special":"quill"},{"special":"ink"},{"special":"folded parchment"},{"special":"small penknife"},{"item":"book|phb","displayName":"borrowed book on the subject of your current study"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cloistered Scholar' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

-- Cobalt Scholar (Sage) is a copy of Sage and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Cormanthor Refugee', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 5, false, false, '## Lifestyle
Poor
...
| 6 | I believe the gods have cursed me, my family, and all of the Cormanthor refugees. We are all doomed, doomed I tell you! |', '[{"_":["two-person tent|phb",{"equipmentType":"toolArtisan"},"holy symbol|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Cormanthor Refugee' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Courtier', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 146, false, false, '## Feature: Court Functionary
...
The noble court or bureaucratic organization where you got your start is directly or indirectly associated with your bond (which could pertain to certain individuals in the group, such as your sponsor or mentor). Your ideal might be concerned with the prevailing philosophy of your court or organization.', '[{"_":["fine clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Courtier' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Criminal', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 129, false, true, '## Feature: Criminal Contact
...
| 6 | An innocent person is in prison for a crime that I committed. I''m okay with that. |', '[{"_":["crowbar|phb",{"item":"common clothes|phb","displayName":"dark common clothes including a hood"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Criminal' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Custom Background', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 126, false, false, '## Feature: Choose a Feature
Choose a feature from any background.

## Suggested Characteristics
Use the suggested characteristics from any background.
{@note See the section on {@book Customizing a Background|PHB|4|Customizing a Background} in the {@book Player''s Handbook|PHB} for more information.}', NULL);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Custom Background' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'any' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Custom Background' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Dimir Operative', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 46, false, false, '## Feature: False Identity
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell encode thoughts|GGR}, {@spell mage hand} |
| 1st | {@spell disguise self}, {@spell sleep} |
| 2nd | {@spell detect thoughts}, {@spell pass without trace} |
| 3rd | {@spell gaseous form}, {@spell meld into stone}, {@spell nondetection} |
| 4th | {@spell arcane eye}, {@spell freedom of movement} |
| 5th | {@spell modify memory} |
...
| d6 | Ideal |
|---|---|
| 1 | {@b Guild}. My true guild is all that really matters. (Any) |
| 2 | {@b Control}. I like pulling the strings. (Lawful) |
| 3 | {@b Secrets}. I collect secrets and never reveal them. (Any) |
| 4 | {@b Knowledge}. I want to know as much as I can about this city and how it works. (Any) |
| 5 | {@b Independence}. I value the freedom to pursue my own goals without interference. (Chaotic) |
| 6 | {@b Nihilism}. I don''t believe in anything, and anyone who does is a fool. (Neutral) |
| d6 | Bond |
|---|---|
...
Like any good spy, you have multiple identities: your true face as an agent of House Dimir; a guildless identity; and a role as a member of another guild. Within that secondary guild, you might already be on a mission for House Dimir, assigned to spy on the guild, collect information about a person, or recruit another spy from the ranks of the guild. Or that guild could be a launching point for your real mission. Perhaps, for example, you were ordered to infiltrate the Azorius in hopes of gaining access to a notorious inmate in an Azorius prison.', '[{"_":[{"special":"Dimir insignia"},{"special":"small knives","quantity":3},{"item":"common clothes|phb","displayName":"dark-colored common clothes"},{"special":"the starting equipment of the background described in this chapter for your secondary guild"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dimir Operative' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Dragon Casualty', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 3, false, false, '## Lifestyle
Wretched
...
|---|---|---|
| 1 | Dockworker/Fisherman | {@filter Vehicles (water)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (water)} |
| 2 | Tradesperson/Merchant | {@filter Artisan''s tools|items|source=phb|miscellaneous=mundane|type=artisan''s tools} |
| 3 | Black Fist Soldier | {@filter Gaming set|items|source=phb|miscellaneous=mundane|type=gaming set} or {@filter Vehicles (land)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (land)} |
| 4 | Adventurer/Visitor | {@filter Vehicles (land)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (land)} |
| 5 | Entertainer | {@filter Musical Instrument|items|source=phb|miscellaneous=mundane|type=instrument} |
| 6 | Scholar/Healer | {@item Alchemist''s Supplies|phb} or {@item Herbalism kit|phb} |
| 7 | Criminal | {@item thieves'' tools|phb}, {@item forgery kit|phb}, or {@item Disguise kit|phb} |
| 8 | Unskilled Laborer | {@filter Gaming set|items|source=phb|miscellaneous=mundane|type=gaming set} |
...
| 6 | Once I make up my mind, I follow my chosen course of action regardless of the consequences. |', '[{"_":["dagger|phb",{"special":"tattered rags"},{"special":"loaf of moldy bread"},{"special":"small cast-off scale belonging to Vorgansharax—the Maimed Virulence"},{"item":"pouch|phb","displayName":"pouch of various coins (salvaged during your escape from Phlan)","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'draconic' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Dragon Casualty' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Earthspur Miner', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil' LIMIT 1), 3, false, false, '## Lifestyle
Poor
...
| 6 | I''m afraid of the dark. |', '[{"a":["shovel|phb"],"b":["miner''s pick|phb"]},{"_":["block and tackle|phb","climber''s kit|phb","common clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'dwarvish' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Earthspur Miner' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'undercommon' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Entertainer', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 130, false, false, '## Feature: By Popular Demand
...
| 6 | Despite my best efforts, I am unreliable to my friends. |', '[{"_":[{"equipmentType":"instrumentMusical"},{"special":"the favor of an admirer (love letter, lock of hair, or trinket)"},"costume clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'acrobatics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Entertainer' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Faceless', (SELECT id FROM sources WHERE name ILIKE 'BGDIA' LIMIT 1), 203, false, false, '## Faceless Persona
...
| 5 | I think far ahead, a detachedness often mistaken for daydreaming. |
| 6 | I see morality entirely in black and white. |', '[{"_":["disguise kit|phb","costume clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faceless' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Faction Agent', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 147, false, false, '## Feature: Safe Haven
...
Your bond might be associated with other members of your faction, or a location or an object that is important to your faction. The ideal you strive for is probably in keeping with the tenets and principles of your faction, but might be more personal in nature.', '[{"_":[{"special":"Badge or emblem of your faction"},{"special":"copy of a seminal faction text (or code-book for a covert faction)"},"common clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'medicine' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Faction Agent' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Failed Merchant', (SELECT id FROM sources WHERE name ILIKE 'AI' LIMIT 1), 49, false, false, '## Feature: Supply Chain
...
| 6 | Nothing gets between me and danger except my fellow adventurers. So I''ll be sure to put them there. |', '[{"_":[{"equipmentType":"toolArtisan"},"merchant''s scale|phb","fine clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Failed Merchant' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Far Traveler', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 148, false, false, '## Feature: All Eyes on You
...
| 6 | I have a weakness for the exotic beauty of the people of these lands. |', '[{"_":["traveler''s clothes|phb",{"special":"poorly wrought maps from your homeland that depict where you are in Faerûn"},{"special":"small piece of jewelry in the style of your homeland''s craftsmanship","worthValue":1000},{"item":"pouch|phb","containsValue":500}]},{"a":[{"equipmentType":"instrumentMusical"}],"b":[{"equipmentType":"setGaming"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Far Traveler' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Feylost', (SELECT id FROM sources WHERE name ILIKE 'WBtW' LIMIT 1), 9, false, false, '## Feature: Feywild Connection
...
| d8 | Visitor |
|---|---|
| 1 | Awakened creature (a Beast or an ordinary plant that has had the {@spell awaken} spell cast on it) |
| 2 | {@creature Centaur} |
| 3 | {@creature Dryad} |
| 4 | {@creature Faerie Dragon (Violet)||Faerie dragon} |
| 5 | {@creature Pixie} |
| 6 | {@creature Satyr} |
| 7 | {@creature Sprite} |
| 8 | {@creature Unicorn} |
...
| 8 | I feel indebted to {@creature Mister Witch|WBtW} and {@creature Mister Light|WBtW} for giving me a home and a purpose. |
| d8 | Flaw |
|---|---|
...
| 8 | I''m always changing my mind—well, almost always. |', '[{"_":[{"equipmentType":"instrumentMusical"},"traveler''s clothes|phb",{"item":"feywild trinket|wbtw","quantity":3},{"item":"pouch|phb","containsValue":800}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Feylost' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Fisher', (SELECT id FROM sources WHERE name ILIKE 'GoS' LIMIT 1), 29, false, false, '## Feature: Harvest the Water
...
| d6 | Ideal |
|---|---|
| 1 | {@b Camaraderie.} Good people make even the longest voyage bearable. (Good) |
| 2 | {@b Luck.} Our luck depends on respecting its rules—now throw this salt over your shoulder. (Lawful) |
| 3 | {@b Daring.} The richest bounty goes to those who risk everything. (Chaotic) |
| 4 | {@b Plunder.} Take all that you can and leave nothing for the scavengers. (Evil) |
| 5 | {@b Balance.} Do not fish the same spot twice in a row; suppress your greed, and nature will reward you. (Neutral) |
| 6 | {@b Hard Work.} No wave can move a soul hard at work. (Any) |
| d6 | Bond |
|---|---|
...
| 6 | I am obsessed with catching an elusive aquatic beast, often to the detriment of other pursuits. |', '[{"_":["fishing tackle|phb","net|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":[{"special":"favorite fishing lure"}],"b":[{"special":"oiled leather wading boots"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Fisher' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Folk Hero', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 131, false, true, '## Feature: Rustic Hospitality
...
| 6 | I have trouble trusting in my allies. |', '[{"_":[{"equipmentType":"toolArtisan"},"shovel|phb","iron pot|phb","common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Folk Hero' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gambler', (SELECT id FROM sources WHERE name ILIKE 'AI' LIMIT 1), 49, false, false, '## Feature: Never Tell Me the Odds
...
| 6 | I''m a great gambler. I''m just bad at math and logic. |', '[{"_":[{"equipmentType":"setGaming"},{"special":"lucky charm"},"fine clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gambler' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gate Urchin', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 6, false, false, '## Lifestyle
Poor
...
| 6 | I do not trust anyone who has not had a hard life.  |', '[{"_":[{"special":"battered alms box"},{"equipmentType":"instrumentMusical"},"common clothes|phb",{"item":"pouch|phb","displayName":"belt pouch"},{"value":1000}]},{"a":[{"special":"cast-off military jacket"}],"b":[{"special":"cap"}],"c":[{"special":"scarf"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Urchin' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gate Warden', (SELECT id FROM sources WHERE name ILIKE 'SatO' LIMIT 1), 7, false, false, '## Feature: Planar Infusion
...
When you make your character, you can roll once on the {@item Gate Warden Trinket|SatO|Gate Warden Trinkets} table, instead of on the {@item Trinket|PHB|Trinkets} table in the Player''s Handbook, for your starting trinket.', '[{"_":[{"special":"ring of keys to unknown locks"},{"item":"book|phb","displayName":"blank book"},{"special":"bottle of black ink"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":["ink pen|phb"],"b":[{"special":"quill"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gate Warden' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Giant Foundling', (SELECT id FROM sources WHERE name ILIKE 'BGG' LIMIT 1), 6, false, false, '## Origin Stories
...
| 6 | The world always feels too big, and I''m afraid I''ll never find my place in it. |', '[{"_":["backpack|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":[{"special":"small stone that reminds you of home"}],"b":[{"special":"sprig that reminds you of home"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Giant Foundling' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Golgari Agent', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 53, false, false, '## Feature: Undercity Paths
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell dancing lights}, {@spell spare the dying} |
| 1st | {@spell entangle}, {@spell ray of sickness} |
| 2nd | {@spell protection from poison}, {@spell ray of enfeeblement}, {@spell spider climb} |
| 3rd | {@spell animate dead}, {@spell plant growth} |
| 4th | {@spell giant insect}, {@spell grasping vine} |
| 5th | {@spell cloudkill}, {@spell insect plague} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Stoicism}. All of us are part of the cyclical march of nature, which will continue with or without us. (Neutral) |
| 3 | {@b Nature}. The natural world is more important than the edifices of the city and civilization. (Neutral) |
| 4 | {@b Interdependence}. We are all part of nature''s web. (Lawful) |
| 5 | {@b Ambition}. The time of Golgari ascendance is at hand, and I intend to have a prominent place in the new world order. (Evil) |
| 6 | {@b Live and Let Live}. Meddling in the affairs of other guilds is a great way to get squashed like a bug. (Neutral) |
| d6 | Bond |
|---|---|
| 1 | I cherish the finger of a family member who was {@condition petrified} by a medusa. |
...
The shamans of the Golgari use their magic to accelerate the cycle of decay and regrowth. You might be sent to spread spores throughout an area that the Golgari want to claim as their territory or to convince the inhabitants of such a territory to abandon it. You might also contend with the ever-present threat of hostile monsters encroaching into Golgari-controlled regions.', '[{"_":[{"special":"Golgari insignia"},"poisoner''s kit|phb","common clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":[{"special":"pet beetle"}],"b":[{"special":"pet spider"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'elvish' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'giant' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'other' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Golgari Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Grinner', (SELECT id FROM sources WHERE name ILIKE 'EGW' LIMIT 1), 200, false, false, '## Feature: Ballad of the Grinning Fool
...
| 6 | I can''t afford to trust anyone. Not. Anyone. |', '[{"_":["fine clothes|phb","disguise kit|phb",{"equipmentType":"instrumentMusical"},{"special":"gold-plated ring depicting a smiling face"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Grinner' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Gruul Anarch', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 60, false, false, '## Feature: Rubblebelt Refuge
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell fire bolt}, {@spell produce flame} |
| 1st | {@spell compelled duel}, {@spell speak with animals}, {@spell thunderwave} |
| 2nd | {@spell beast sense}, {@spell shatter} |
| 3rd | {@spell conjure animals}, {@spell conjure barrage} |
| 4th | {@spell dominate beast}, {@spell stoneskin} |
| 5th | {@spell destructive wave} |
...
| d6 | Ideal |
|---|---|
| 1 | {@b Clan}. My clan is all that really matters. (Any) |
| 2 | {@b Anarchy}. No person or law or custom can tell another what to do. (Chaotic) |
| 3 | {@b Nature}. We weren''t born tame or domesticated, so we shouldn''t have to live that way. (Neutral) |
| 4 | {@b Might}. The strongest are meant to dominate the weak. (Evil) |
| 5 | {@b Rage}. AAAAAARRRRggggh! [To live is to feel and express the rage burning in your belly.] (Chaotic) |
| 6 | {@b Tradition}. The Old Ways must be preserved and upheld. (Any) |
| d6 | Bond |
|---|---|
...
Sometimes your objective might be more esoteric. With prophecies of the return of Ilharg the Raze-Boar spreading like wildfire among the Gruul druids, you might be asked to carry out some task that the druids believe will speed his coming. Such a task might involve collecting a sacred relic held in an Orzhov vault or collecting sacrifices for a grand ceremony in the Raze-Boar''s honor.', '[{"_":[{"special":"Gruul insignia"},"hunting trap|phb","herbalism kit|phb",{"special":"the skull of a boar"},{"special":"beast-hide cloak"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'draconic' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'giant' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'goblin' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'sylvan' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Gruul Anarch' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Guild Artisan', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 132, false, false, '## Feature: Guild Membership
...
| 6 | I''m horribly jealous of anyone who can outshine my handiwork. Everywhere I go, I''m surrounded by rivals. |', '[{"_":[{"equipmentType":"toolArtisan"},{"special":"letter of introduction from your guild"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Guild Artisan' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Harborfolk', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil' LIMIT 1), 4, false, false, '## Lifestyle
Poor
...
| 6 | I am a secret informant for the Hawks. I send them reports about everything I see and hear, even what my friends and allies are up to. |', '[{"_":["fishing tackle|phb","dice set|phb","playing card set|phb",{"item":"three-dragon ante set|phb","displayName":"or Three-Dragon Ante set"},"common clothes|phb","rowboat",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Harborfolk' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Haunted One', (SELECT id FROM sources WHERE name ILIKE 'VRGR' LIMIT 1), 34, false, false, '## Feature: Heart of Darkness
...
| 12 | I know the ends always justify the means and am quick to make sacrifices to attain my goals. |', '[{"_":["monster hunter''s pack|vrgr","common clothes|phb",{"item":"Horror Trinket|VRGR","displayName":"trinket of special significance (choose one or roll on the Horror Trinkets table)"},{"value":10}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Haunted One' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hermit', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 134, false, false, '## Feature: Discovery
...
| 6 | I like keeping secrets and won''t share them with anyone. |', '[{"_":[{"item":"map or scroll case|phb","displayName":"scroll case stuffed full of notes from your studies or prayers"},{"item":"blanket|phb","displayName":"winter blanket"},"common clothes|phb","herbalism kit|phb",{"value":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'medicine' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hermit' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hillsfar Merchant', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 7, false, false, '## Lifestyle
Wealthy
...
| 6 | I am overconfident. I overestimate my abilities. |', '[{"_":["fine clothes|phb","signet ring|phb",{"special":"letter of introduction from your family''s trading house"},{"special":"purse","containsValue":2500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Merchant' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Hillsfar Smuggler', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 8, false, false, '## Lifestyle
Modest
...
| 6 | I''m an informant for the Red Plumes. They let me continue my activities, so long as I pass them information about illegal activity in Hillsfar. |', '[{"_":["forgery kit|phb","common clothes|phb",{"item":"pouch|phb","displayName":"belt pouch"},{"value":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Hillsfar Smuggler' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('House Agent', (SELECT id FROM sources WHERE name ILIKE 'ERLW' LIMIT 1), 53, false, false, '| Your House | Proficiencies |
|---|---|
| Cannith | {@item Alchemist''s supplies|phb} and {@item tinker''s tools|phb} |
| Deneith | One {@filter gaming set|items|source=phb|miscellaneous=mundane|type=gaming set} and {@filter vehicles (land)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (land)} |
| Ghallanda | {@item Brewer''s supplies|phb} and {@item cook''s utensils|phb} |
| Jorasco | {@item Alchemist''s supplies|phb} and {@item herbalism kit|phb} |
| Kundarak | {@item Thieves'' tools|phb} and {@item tinker''s tools|phb} |
| Lyrandar | {@item Navigator''s tools|phb} and {@filter vehicles (sea and air)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (water);vehicle (air)} |
| Medani | {@item Disguise kit|phb} and {@item thieves'' tools|phb} |
| Orien | One {@filter gaming set|items|source=phb|miscellaneous=mundane|type=gaming set} and {@filter vehicles (land)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (land)} |
| Phiarlan | {@item Disguise kit|phb} and one {@filter musical instrument|items|source=phb|miscellaneous=mundane|type=instrument} |
| Sivis | {@item Calligrapher''s supplies|phb} and {@item forgery kit|phb} |
| Tharashk | One {@filter gaming set|items|source=phb|miscellaneous=mundane|type=gaming set} and {@item thieves'' tools|phb} |
| Thuranni | One {@filter musical instrument|items|source=phb|miscellaneous=mundane|type=instrument} and {@item poisoner''s kit|phb} |
| Vadalis | {@item herbalism kit|phb} and {@filter vehicles (land)|items|source=phb;dmg|miscellaneous=mundane|type=vehicle (land)} |
...
| d6 | Ideal |
|---|---|
| 1 | {@b Common Good}. My house serves a vital function, and its prosperity will help everyone. (Good) |
| 2 | {@b Tradition}. I uphold traditions of my house and bring honor to my family. (Lawful) |
| 3 | {@b Innovation}. Abandon old traditions and find better ways to do things. (Chaotic) |
| 4 | {@b Power}. I want to ensure the prosperity of my house and wield its power myself. (Evil) |
| 5 | {@b Discovery}. I want to learn all I can, both for my house and for my own curiosity. (Any) |
| 6 | {@b Comfort}. I want to ensure that me and mine enjoy the best things in life. (Any) |
| d6 | Bond |
|---|---|
...
| 6 | I''m working for a hidden faction in my house that gives me secret assignments. |', '[{"_":["fine clothes|phb",{"item":"signet ring|phb","displayName":"house signet ring"},{"special":"identification papers"},{"special":"purse","containsValue":2000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'tinker''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'brewer''s supplies' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'cook''s utensils' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'alchemist''s supplies' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'tinker''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (air)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'calligrapher''s supplies' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'House Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit' LIMIT 1), FALSE);
...
INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Inheritor', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 150, false, false, '## Feature: Inheritance
...
Your bond might be directly related to your inheritance, or to the person from whom you received it. Your ideal might be influenced by what you know about your inheritance, or by what you intend to do with your gift once you realize what it is capable of.', '[{"_":[{"special":"Your inheritance"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1500}]},{"a":[{"equipmentType":"setGaming"}],"b":[{"equipmentType":"instrumentMusical"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inheritor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Initiate', (SELECT id FROM sources WHERE name ILIKE 'PSA' LIMIT 1), 8, false, false, '## Feature: Trials of the Five Gods
...
| d6 | Ideal |
|---|---|
| 1 | {@b Solidarity.} The thing that matters most of all is that we''re there for each other. (Lawful) |
| 2 | {@b Knowledge.} The world is a puzzle—a mystery waiting to be solved. (Neutral) |
| 3 | {@b Strength.} All that matters to me is my own perfection. Let everyone else seek that perfection in their own way. (Any) |
| 4 | {@b Ambition.} I''m going to prove that I deserve only the best—of everything. (Evil) |
| 5 | {@b Zeal.} Anything worth doing is worth throwing my whole self into. (Any) |
| 6 | {@b Redemption.} I will train all the harder to make up for the doubt I entertained when I was younger. (Any) |
| d6 | Bond |
|---|---|
...
| 6 | I think I''ve figured out that this world is not what it seems. Something dark is going on here. |', '[{"_":[{"special":"simple puzzle box"},{"special":"scroll containing the basic teachings of the five gods"},{"equipmentType":"setGaming"},"common clothes|phb",{"item":"pouch|phb","containsValue":1500},{"special":"any cartouches you have earned"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Initiate' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

-- Initiate (Dissenter) is a copy of Initiate and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Inquisitor', (SELECT id FROM sources WHERE name ILIKE 'PSI' LIMIT 1), 12, false, false, '## Feature: Legal Authority
As an inquisitor of the church, you have the authority to arrest criminals. In the absence of other authorities, you are authorized to pass judgement and even carry out sentencing. If you abuse this power, however, your superiors in the church might strip it from you.', '[{"_":["holy symbol|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Inquisitor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Investigator', (SELECT id FROM sources WHERE name ILIKE 'VRGR' LIMIT 1), 35, false, false, '## Feature: Official Inquiry
...
| 10 | I''m exceptionally cautious, planning laboriously and devising countless contingencies. |
| 11 | I have a reputation for defeating a great evil, but that''s a lie and the wicked force knows. |
| 12 | I know the ends always justify the means and am quick to make sacrifices to attain my goals. |', '[{"_":["magnifying glass|PHB","common clothes|phb",{"item":"Horror Trinket|VRGR","displayName":"evidence from a past case (choose one or roll for a trinket from the {@item Horror Trinket|VRGR|Horror Trinkets})"},{"value":10}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Investigator' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Iron Route Bandit', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 5, false, false, '## Lifestyle
Poor
...
| 6 | I judge people based on how well they stand their ground in a fight. I got not time for cowards... |', '[{"_":[{"item":"common clothes|phb","displayName":"dark common clothes"},"pack saddle|phb","burglar''s pack|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Iron Route Bandit' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Izzet Engineer', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 66, false, false, '## Feature: Urban Infrastructure
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell produce flame}, {@spell shocking grasp} |
| 1st | {@spell chaos bolt|XGE}, {@spell create or destroy water}, {@spell unseen servant} |
| 2nd | {@spell heat metal}, {@spell rope trick} |
| 3rd | {@spell call lightning}, {@spell elemental weapon}, {@spell glyph of warding} |
| 4th | {@spell conjure minor elementals}, {@spell divination}, {@spell Otiluke''s resilient sphere} |
| 5th | {@spell animate objects}, {@spell conjure elemental} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Creativity}. Half the world''s troubles come from stodgy thinking, stuck in the past. We need innovative solutions. (Chaotic) |
| 3 | {@b Discovery}. Every experiment has the potential to reveal more secrets of the multiverse. (Any) |
| 4 | {@b Science}. A rigorous application of logical principles and protocols will lead us toward progress more surely than any belief system. (Lawful) |
| 5 | {@b Fun}. I love my job! Despite the dangerous working conditions, there''s nothing I''d rather do. (Chaotic) |
| 6 | {@b Power}. Someday I''ll find or create the magic that will make me the most powerful being in Ravnica. (Evil) |
| d6 | Bond |
|---|---|
...
## How Do I Fit In?
Whatever your role in the Izzet League, you are expected to contribute to its research in some way. That contribution might involve participating in tests, whether as an assistant, a researcher, or a subject. You might be one of the soldiers who protects a laboratory, or a laborer responsible for lifting heavy pieces of equipment into place. Everyone''s contribution matters, even if the Izzet know that some matter more than others.', '[{"_":[{"special":"Izzet insignia"},{"equipmentType":"toolArtisan"},{"special":"the charred and twisted remains of a failed experiment"},"hammer|phb","block and tackle|phb","common clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'draconic' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'goblin' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'other' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Izzet Engineer' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Knight of Solamnia', (SELECT id FROM sources WHERE name ILIKE 'DSotDQ' LIMIT 1), 30, false, false, '## Feature: Squire of Solamnia
...
| 6 | A locket with a sketch of a silver dragon inside |', '[{"_":[{"special":"insignia of rank"},"playing card set|phb","common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of Solamnia' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Knight of the Order', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 151, false, false, '## Feature: Knightly Regard
...
Your bond almost always involves the order to which you belong (or at least key members of it), and it is highly unusual for a knight''s ideal not to reflect the agenda, sentiment, or philosophy of one''s order.', '[{"_":["traveler''s clothes|phb",{"special":"signet, banner, or seal representing your place or rank in the order"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Knight of the Order' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Lorehold Student', (SELECT id FROM sources WHERE name ILIKE 'SCC' LIMIT 1), 31, false, false, '## Feature: Lorehold Initiate
...
| Spell Level | Spells |
|---|---|
| 1st | {@spell Comprehend Languages}, {@spell Identify} |
| 2nd | {@spell Borrowed Knowledge|SCC}, {@spell Locate Object} |
| 3rd | {@spell Speak with Dead}, {@spell Spirit Guardians} |
| 4th | {@spell Arcane Eye}, {@spell Stone Shape} |
| 5th | {@spell Flame Strike}, {@spell Legend Lore} |
...
### Lorehold Trinkets
When you make your character, you may roll once on the {@item Lorehold Trinket|SCC|Lorehold Trinkets} table, instead of on the {@item trinket|phb|Trinkets table} in the {@book Player''s Handbook|PHB}, for your starting trinket.', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb","hammer|phb","hooded lantern|phb","tinderbox|phb",{"special":"tome of history"},{"special":"school uniform"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lorehold Student' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

-- Luxonborn (Acolyte) is a copy of Acolyte and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Lyceum Scholar', (SELECT id FROM sources WHERE name ILIKE 'TDCSR' LIMIT 1), 183, false, false, '## Feature: Academic Requisition
...
| {@dice d8} | Personality Trait |
|---|---|
| 1 | I can''t believe I''m here! At the {@book Alabaster Lyceum|TDCSR|3|5. Alabaster Lyceum}. Oh, gods, I''ve dreamed of this my whole life, and now I''m here! |
...
| {@dice d6} | Ideal |
|---|---|
| 1 | {@b Preparedness}. I can''t go out into the world unless I know what I''m up against. Study first, act later. (Neutral) |
| 2 | {@b Stardom}. Having a team is good and all, but you can''t win a game of ball without the star charger, and you know that''s me. (Evil) |
| 3 | {@b Individuality}. The world keeps us down by trying to put us all into little boxes. I''m tired of living in my box, and I don''t care what you think about it. (Chaotic) |
| 4 | {@b Purpose}. I study because there are things I need to know. I''ll find my place in the world, and I''ll make the world better. (Good) |
| 5 | {@b Code of Conduct}. The student code is there to benefit all students, you know. It''s the same for laws! (Lawful) |
| 6 | {@b Recreation}. All this studying crap wasn''t worth anything if you weren''t partying when you were done. Meet me down at the tavern, okay? (Chaotic) |
| {@dice d6} | Bond |
|---|---|
| 1 | I came to the {@book Lyceum|TDCSR|3|5. Alabaster Lyceum} with no one, but I fell in love with the city of {@book Emon|TDCSR|3|Emon, the City of Fellowship}. I''ve finally found a place that feels like home! |
...
| 4 | I came to the {@book Lyceum|TDCSR|3|5. Alabaster Lyceum} with a childhood friend, but we''ve long been drifting apart. |
| 5 | Discovery is the only thing that matters to me. The topic doesn''t matter. Books keep me company on my loneliest days. |
| 6 | The {@book Lyceum|TDCSR|3|5. Alabaster Lyceum} is my life. I''d give up anything—everything—to protect it from harm. |
| {@dice d6} | Flaw |
|---|---|
| 1 | The {@book Lyceum|TDCSR|3|5. Alabaster Lyceum} taught me to never want to leave my room. The campus was so huge, and the crowds were so horrible. |
...
| 6 | I''m always striving for perfection. I got top of my class, sure, but only with a 98 average. And that''s. Not. Perfect. |', '[{"_":[{"item":"fine clothes|phb","displayName":"A set of fine clothes"},{"special":"student uniform"},{"item":"writing kit|TDCSR"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Lyceum Scholar' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mage of High Sorcery', (SELECT id FROM sources WHERE name ILIKE 'DSotDQ' LIMIT 1), 30, false, false, '## Feature: Initiate of High Sorcery
...
| 6 | A lens through which you can see Krynn''s invisible black moon, Nuitari |', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb","common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mage of High Sorcery' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Marine', (SELECT id FROM sources WHERE name ILIKE 'GoS' LIMIT 1), 31, false, false, '## Feature: Steady
...
| d6 | Ideal |
|---|---|
| 1 | {@b Teamwork.} Success depends on cooperation and communication. (Good) |
| 2 | {@b Code.} The marines'' code provides a solution for every problem, and following it is imperative. (Lawful) |
| 3 | {@b Embracing.} Life is messy. Throwing yourself into the worst of it is necessary to get the job done. (Chaotic) |
| 4 | {@b Might.} The strong train so that they might rule those who are weak. (Evil) |
| 5 | {@b Bravery.} To act when others quake in fear—this is the essence of the warrior. (Any) |
| 6 | {@b Perseverance.} No injury or obstacle can turn me from my goal. (Any) |
| d6 | Bond |
|---|---|
...
| 6 | I sometimes stay up all night listening to the ghosts of my fallen enemies. |', '[{"_":[{"item":"dagger|phb","displayName":"dagger that belonged to a fallen comrade"},{"special":"folded flag emblazoned with the symbol of your ship or company"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Marine' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mercenary Veteran', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 152, false, false, '## Feature: Mercenary Life
...
Your bond could be associated with the company you traveled with previously, or with some of the comrades you served with. The ideal you embrace largely depends on your worldview and your motivation for fighting.', '[{"_":[{"item":"traveler''s clothes|phb","displayName":"uniform of your company"},{"special":"insignia of your rank"},{"equipmentType":"setGaming"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mercenary Veteran' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Mulmaster Aristocrat', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil' LIMIT 1), 5, false, false, '## Lifestyle
Wealthy
...
| 6 | I have no artistic sense. I hide that fact behind extreme opinions and have become a trendsetter.  |', '[{"a":[{"equipmentType":"toolArtisan"}],"b":[{"equipmentType":"instrumentMusical"}]},{"_":["fine clothes|phb",{"special":"purse","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Mulmaster Aristocrat' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

-- Myriad Operative (Criminal) is a copy of Criminal and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Noble', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 135, false, true, '## Feature: Position of Privilege
...
| 6 | By my words and actions, I often bring shame to my family. |', '[{"_":["fine clothes|phb","signet ring|phb",{"special":"scroll of pedigree"},{"special":"purse","containsValue":2500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Noble' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Orzhov Representative', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 72, false, false, '## Feature: Leverage
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell friends}, {@spell guidance} |
| 1st | {@spell command}, {@spell illusory script} |
| 2nd | {@spell enthrall}, {@spell ray of enfeeblement}, {@spell zone of truth} |
| 3rd | {@spell bestow curse}, {@spell speak with dead}, {@spell spirit guardians} |
| 4th | {@spell blight}, {@spell death ward}, {@spell Leomund''s secret chest} |
| 5th | {@spell geas} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Wealth}. I will do whatever it takes to become as rich as the oligarchs. (Evil) |
| 3 | {@b Power}. One day, I will be the one giving orders. (Evil) |
| 4 | {@b Prestige}. I want to be admired, respected, feared, or even hated for my position and wealth. (Evil) |
| 5 | {@b Stability}. The economy functions best when chaos is kept under control and everyone knows their place. (Lawful) |
| 6 | {@b Eternity}. I want to live forever—in the flesh as long as possible, and as a spirit afterward. (Any) |
| d6 | Bond |
|---|---|
...
For most of your career, you can expect to engage in some aspect of the day-to-day criminal operations of the guild. That can mean throwing your weight around to enforce the will of the guild or using religious authority to extort offerings from the people. But it can also mean doing various errands for your superiors, from bearing messages to carrying out assassinations.', '[{"_":[{"special":"Orzhov insignia"},{"special":"foot-long chain made of ten gold coins"},{"special":"vestments"},"fine clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Orzhov Representative' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Outlander', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 136, false, false, '## Feature: Wanderer
...
| 6 |  Don''t expect me to save those who can''t save themselves. It is nature''s way that the strong thrive and the weak perish. |', '[{"_":["staff|phb","hunting trap|phb",{"special":"trophy from an animal you killed"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Outlander' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Phlan Insurgent', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 6, false, false, '## Lifestyle
Poor
...
| 6 | I relentlessly despise the Maimed Virulence and his allies. I''d abandon other goals in order to strike out at them. |', '[{"_":[{"item":"caltrops (bag of 20)|phb","displayName":"bag of caltrops (bag of 20)"},{"item":"trinket|phb","displayName":"small trinket that connects you to the life you once had before the occupation of Phlan"},"healer''s kit|phb",{"item":"common clothes|phb","displayName":"dark common clothes that includes a cloak and hood"},{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Insurgent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Phlan Refugee', (SELECT id FROM sources WHERE name ILIKE 'ALElementalEvil' LIMIT 1), 6, false, false, '## Lifestyle
Modest
...
| 6 | When something goes wrong, it''s never my fault. |', '[{"_":[{"equipmentType":"toolArtisan"},{"special":"token of the life you once knew"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Phlan Refugee' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Plaintiff', (SELECT id FROM sources WHERE name ILIKE 'AI' LIMIT 1), 50, false, false, '## Feature: Legalese
...
| 6 | If people find me unpleasant, that''s their problem. |', '[{"_":[{"equipmentType":"toolArtisan"},"fine clothes|phb",{"value":2000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'medicine' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Plaintiff' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Planar Philosopher', (SELECT id FROM sources WHERE name ILIKE 'SatO' LIMIT 1), 8, false, false, '| Faction | Skill |
|---|---|
| Athar | {@skill Religion} |
| Bleak Cabal | {@skill Insight} |
| Doomguard | {@skill Nature} |
| Fated | {@skill Intimidation} |
| Fraternity of Order | {@skill History} |
| Hands of Havoc | {@skill Stealth} |
| Harmonium | {@skill Perception} |
| Heralds of Dust | {@skill Medicine} |
| Mercykillers | {@skill Survival} |
| Mind''s Eye | {@skill Persuasion} |
| Society of Sensation | {@skill Performance} |
| Transcendent Order | {@skill Athletics} |
...
When you make your character, you can roll once on the {@item Planar Philosopher Trinket|SatO|Planar Philosopher Trinkets} table, instead of on the {@item Trinket|PHB|Trinkets} table in the Player''s Handbook, for your starting trinket.', '[{"_":[{"special":"portal key (such as a bag of golden tea leaves or the tooth of a planar beast)"},{"special":"manifesto of your guiding philosophy"},{"item":"common clothes|phb","displayName":"common clothes in your faction''s style"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'medicine' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), TRUE, 1);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Planar Philosopher' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Prismari Student', (SELECT id FROM sources WHERE name ILIKE 'SCC' LIMIT 1), 32, false, false, '## Feature: Prismari Initiate
...
| Spell Level | Spells |
|---|---|
| 1st | {@spell Chromatic Orb}, {@spell Thunderwave} |
| 2nd | {@spell Flaming Sphere}, {@spell Kinetic Jaunt|SCC} |
| 3rd | {@spell Haste}, {@spell Water Walk} |
| 4th | {@spell Freedom of Movement}, {@spell Wall of Fire} |
| 5th | {@spell Cone of Cold}, {@spell Conjure Elemental} |
...
### Prismari Trinkets
When you make your character, you may roll once on the {@item Prismari Trinket|SCC|Prismari Trinkets} table, instead of on the {@item trinket|phb|Trinkets table} in the {@book Player''s Handbook|PHB}, for your starting trinket.', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb"]},{"a":[{"equipmentType":"toolArtisan"}],"b":[{"equipmentType":"instrumentMusical"}]},{"_":[{"special":"school uniform"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'acrobatics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Prismari Student' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Quandrix Student', (SELECT id FROM sources WHERE name ILIKE 'SCC' LIMIT 1), 33, false, false, '## Feature: Quandrix Initiate
...
| Spell Level | Spells |
|---|---|
| 1st | {@spell Entangle}, {@spell Guiding Bolt} |
| 2nd | {@spell Enlarge/Reduce}, {@spell Vortex Warp|SCC} |
| 3rd | {@spell Aura of Vitality}, {@spell Haste} |
| 4th | {@spell Control Water}, {@spell Freedom of Movement} |
| 5th | {@spell Circle of Power}, {@spell Passwall} |
...
### Quandrix Trinkets
When you make your character, you may roll once on the {@item Quandrix Trinket|SCC|Quandrix Trinkets} table, instead of on the {@item trinket|phb|Trinkets table} in the {@book Player''s Handbook|PHB}, for your starting trinket.', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb","abacus|phb",{"special":"book of arcane theory"},{"special":"school uniform"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Quandrix Student' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rakdos Cultist', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 79, false, false, '## A Flair for the Dramatic
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell fire bolt}, {@spell vicious mockery} |
| 1st | {@spell burning hands}, {@spell dissonant whispers}, {@spell hellish rebuke} |
| 2nd | {@spell crown of madness}, {@spell enthrall}, {@spell flaming sphere} |
| 3rd | {@spell fear}, {@spell haste} |
| 4th | {@spell confusion}, {@spell wall of fire} |
| 5th | {@spell dominate person} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Hedonism}. Death comes for everyone, so take as much pleasure as you can from every moment of life. (Neutral) |
| 3 | {@b Creativity}. I strive to find more ways to express my art through pain—my own as well as others''. (Chaotic) |
| 4 | {@b Freedom}. No one tells me what to do. (Chaotic) |
| 5 | {@b Equality}. I want to see Ravnica remade, with no guilds and no hierarchies. (Chaotic) |
| 6 | {@b Spectacle}. People are inspired by the greatness they see in art. (Any) |
| d6 | Bond |
|---|---|
...
You work as part of a troupe, with your artistic talents used in service to a ringmaster''s vision. But your performance is your own, and no one expects you to follow a script. In fact, if you go through a performance without doing something you haven''t done before, you''re clearly not trying hard enough.', '[{"_":[{"special":"Rakdos insignia"},{"equipmentType":"instrumentMusical"},"costume clothes|phb",{"item":"hooded lantern|phb","displayName":"hooded lantern made of wrought iron"},{"special":"10-foot length of chain with sharply spiked links"},"tinderbox|phb",{"item":"torch|phb","quantity":10},"common clothes|phb",{"item":"pouch|phb","containsValue":1000},{"special":"bottle of sweet, red juice"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'acrobatics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'abyssal' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'giant' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rakdos Cultist' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Reformed Cultist', (SELECT id FROM sources WHERE name ILIKE 'TDCSR' LIMIT 1), 185, false, false, '## Feature: Fell Teachings
...
| {@dice d8} | Personality Trait |
|---|---|
| 1 | I need a {@item dagger|phb} close at hand at all times. Just in case they find me. |
...
| {@dice d6} | Ideal |
|---|---|
| 1 | {@b Life}. I''ve spent too long shackled to an evil master. No matter what happened before, I deserve my freedom now. (Chaotic) |
| 2 | {@b Redemption}. People can change, but redemption must be something they choose for themselves. If they do, it is my duty to help them along that path. (Good) |
| 3 | {@b Power}. When I abandoned the cult, it wasn''t out of some misguided sense of righteousness. That pathetic organization was merely a shackle on my potential. (Evil) |
| 4 | {@b Vengeance}. The cult has poisoned my life. I will see all its followers suffer. (Any) |
| 5 | {@b Hierarchy}. The cult was vile, but its strength was in stability and organization. As long as good folk lack unity, evil will always triumph. (Lawful) |
| 6 | {@b Reparations}. As a cultist, I harmed people whose names I''ll never know. I feel obligated to repay my debt by aiding others. (Good) |
| {@dice d6} | Bond |
|---|---|
| 1 | My cousin escaped the cult with me. I lost track of them when we fled, but I know they''re alive. I can feel it. |
| 2 | I was saved from the cult by a priest of one of the {@book Prime Deities|TDCSR|2|Prime Deities}. If not for that sign of faith, I would surely be lost. |
...
| 4 | Organized religion terrifies me. {@book Betrayer Gods|TDCSR|2|Betrayer Gods} or {@book Prime Deities|TDCSR|2|Prime Deities}...it doesn''t matter. The sight of the faithful freezes my blood cold. |
| 5 | Oh, I always tell the truth. Always. I''ve never had to keep a secret from anyone, so of course I''ll be open with you. |
| 6 | I don''t trust easily. If you grew up being lied to about every little thing? The fundamental nature of the world? You wouldn''t, either. |', '[{"_":[{"special":"vestments"},{"item":"holy symbol|phb","displayName":"a holy symbol of your previous cult"},"common clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Reformed Cultist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), FALSE);

-- Revelry Pirate (Sailor) is a copy of Sailor and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rewarded', (SELECT id FROM sources WHERE name ILIKE 'BMT' LIMIT 1), 57, false, false, '## Feature: Fortune''s Favor
...
| 6 | Half a medallion designed to be rejoined to its other half |', '[{"_":[{"special":"bottle of black ink"},"ink pen|phb",{"special":"sheets of paper","quantity":5},{"item":"gaming set|phb","displayName":"gaming set (matching your chosen proficiency)"},"signet ring|phb","fine clothes|phb",{"item":"pouch|phb","containsValue":1800}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rewarded' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rival Intern', (SELECT id FROM sources WHERE name ILIKE 'AI' LIMIT 1), 51, false, false, '## Feature: Inside Informant
...
| 6 | Our superiors might not like what you''re doing. I''m going to have to put that in my report. |', '[{"_":[{"equipmentType":"toolArtisan"},{"special":"ledger from your previous employer containing a small piece of useful information"},"fine clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rival Intern' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ruined', (SELECT id FROM sources WHERE name ILIKE 'BMT' LIMIT 1), 58, false, false, '## Feature: Still Standing
...
| 6 | A keepsake from someone you were once close to but who is now your enemy |', '[{"_":[{"item":"hourglass|phb","displayName":"cracked hourglass"},{"item":"manacles|phb","displayName":"set of rusty manacles"},{"special":"half-empty bottle"},"hunting trap|phb",{"item":"gaming set|phb","displayName":"gaming set (matching your chosen proficiency)"},"traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1300}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ruined' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Rune Carver', (SELECT id FROM sources WHERE name ILIKE 'BGG' LIMIT 1), 12, false, false, '## Rune Styles
...
| 6 | My brain struggles to process words written in ink, but the feeling of carved runes makes my mind sing. |', '[{"_":[{"equipmentType":"toolArtisan"},{"special":"small knife"},"whetstone|phb","common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'giant' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Rune Carver' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Sage', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 137, false, true, '## Feature: Researcher
...
| 6 | I can''t keep a secret to save my life, or anyone else''s. |', '[{"_":["ink (1-ounce bottle)|phb",{"special":"quill"},{"special":"small knife"},{"special":"letter from a dead colleague posing a question you have not yet been able to answer"},"common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sage' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Sailor', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 139, false, false, '## Feature: Ship''s Passage
...
| 6 | My pride will probably lead to my destruction. |', '[{"_":[{"item":"club|phb","displayName":"belaying pin"},"silk rope (50 feet)|phb",{"item":"trinket|phb","displayName":"lucky charm"},"common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Sailor' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Secret Identity', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 9, false, false, '## Lifestyle
Modest
...
| 6 | Years of successfully deceiving others have made me cocky. I think no one can see through my lies. |', '[{"_":["disguise kit|phb","forgery kit|phb","common clothes|phb",{"item":"pouch|phb","displayName":"belt pouch"},{"value":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Secret Identity' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Selesnya Initiate', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 86, false, false, '## Feature: Conclave''s Shelter
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell druidcraft}, {@spell friends} |
| 1st | {@spell animal friendship}, {@spell charm person} |
| 2nd | {@spell aid}, {@spell animal messenger}, {@spell calm emotions}, {@spell warding bond} |
| 3rd | {@spell plant growth}, {@spell speak with plants} |
| 4th | {@spell aura of life}, {@spell conjure minor elementals} |
| 5th | {@spell awaken}, {@spell commune with nature} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Harmony}. Nothing is more beautiful than voices and actions aligned in common purpose. (Good) |
| 3 | {@b Order}. Like a well-pruned tree, society thrives when everything is kept in good order. (Lawful) |
| 4 | {@b Life}. Preserving life and nature is always a worthwhile endeavor. (Good) |
| 5 | {@b Humility}. Ambition and pride are the roots of strife. (Good) |
| 6 | {@b Evangelism}. When all have joined the Selesnya Conclave, Ravnica will finally know peace. (Any) |
| d6 | Bond |
|---|---|
...
That said, you must never lose sight of the fact that you are part of a larger community. That includes the whole guild, of course, but your ties to community start with your vernadi (enclave) and its voda (dryad leader). The dryads want to know what you''re doing and what purpose it serves, and they act to curtail your actions—or even expel you from the guild—if they determine that you aren''t serving Selesnya''s best interests.', '[{"_":[{"special":"Selesnya insignia"},"healer''s kit|phb","robes|phb","common clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'elvish' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'other' LIMIT 1), TRUE, 1);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'sylvan' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Selesnya Initiate' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Shade Fanatic', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 10, false, false, '## Lifestyle
Modest
...
| 6 | I know what I do is wrong, but am afraid to speak up about it. |', '[{"_":["forgery kit|phb",{"special":"transparent cylinder of shadow that has no opening"},"signet ring|phb","fine clothes|phb",{"value":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'other' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shade Fanatic' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'forgery kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Shipwright', (SELECT id FROM sources WHERE name ILIKE 'GoS' LIMIT 1), 33, false, false, '## Feature: I''ll Patch It!
...
| d6 | Sea''s Influence |
|---|---|
| 1 | {@b Grand Designs.} You are working on plans and schematics for a new, very fast ship. You must examine as many different kinds of vessels as possible to help ensure the success of your design. |
| 2 | {@b Solid and Sound.} You patched up a war galley and prevented it from sinking. The local navy regards you as a friend. |
| 3 | {@b Favored.} You insisted on thicker planking for a merchant vessel''s hull, which saved it from sinking when it smashed against a reef. You have a standing invitation to visit the merchant''s distant mansion. |
| 4 | {@b Master of Armaments.} You specialized in designing and mounting defenses for the navy. You easily recognize and determine the quality of such items. |
| 5 | {@b Low Places.} You have contacts in the smuggling outfits along the coast; you occasionally repair the criminals'' ships in exchange for coin and favors. |
| 6 | {@b Mysteries of the Deep.} You experienced an encounter with a possibly divine being while sailing alone. Work with your DM to determine the secret about the deep waters of the sea that this entity revealed to you. |
...
| 6 | I sometimes take things that don''t belong to me, especially if they are very well made. |', '[{"_":[{"item":"carpenter''s tools|phb","displayName":"set of well-loved carpenter''s tools"},{"item":"book|phb","displayName":"blank book"},"ink (1-ounce bottle)|phb","ink pen|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'carpenter''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Shipwright' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Silverquill Student', (SELECT id FROM sources WHERE name ILIKE 'SCC' LIMIT 1), 35, false, false, '## Feature: Silverquill Initiate
...
| Spell Level | Spells |
|---|---|
| 1st | {@spell Dissonant Whispers}, {@spell Silvery Barbs|SCC} |
| 2nd | {@spell Calm Emotions}, {@spell Darkness} |
| 3rd | {@spell Beacon of Hope}, {@spell Daylight} |
| 4th | {@spell Compulsion}, {@spell Confusion} |
| 5th | {@spell Dominate Person}, {@spell Rary''s Telepathic Bond} |
...
When you make your character, you may roll once on the {@item Silverquill Trinket|SCC|Silverquill Trinkets} table, instead of on the {@item trinket|phb|Trinkets table} in the {@book Player''s Handbook|PHB}, for your starting trinket.', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb",{"special":"book of poetry"},{"special":"school uniform"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Silverquill Student' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Simic Scientist', (SELECT id FROM sources WHERE name ILIKE 'GGR' LIMIT 1), 93, false, false, '## Clades and Projects
...
| Spell Level | Spells |
|---|---|
| Cantrip | {@spell acid splash}, {@spell druidcraft} |
| 1st | {@spell detect poison and disease}, {@spell expeditious retreat}, {@spell jump} |
| 2nd | {@spell alter self}, {@spell enhance ability}, {@spell enlarge/reduce} |
| 3rd | {@spell gaseous form}, {@spell water breathing}, {@spell wind wall} |
| 4th | {@spell freedom of movement}, {@spell polymorph} |
| 5th | {@spell creation} |
...
|---|---|
| 1 | {@b Guild}. My guild is all that really matters. (Any) |
| 2 | {@b Change}. All life is meant to progress toward perfection, and our work is to hurry it along—no matter what must be upended along the way. (Chaotic) |
| 3 | {@b Knowledge}. Understanding the world is more important than what you do with your knowledge. (Neutral) |
| 4 | {@b Greater Good}. I want to reshape the world into higher forms of life so that all can enjoy evolution. (Good) |
| 5 | {@b Logic}. It''s foolish to let emotions and principles interfere with the conclusions of logic. (Lawful) |
| 6 | {@b Superiority}. My vast intellect and strength are directed toward increasing my sway over others. (Evil) |
| d6 | Bond |
|---|---|
...
Self-improvement is also an important part of your mission. Anything you can do to make yourself more capable—whether learning a new spell or adopting a new hybridizing mutation—gives the Simic a stronger weapon in its arsenal. The combine must change to survive, and that means individual members of the guild must grow and adapt as well.', '[{"_":[{"special":"Simic insignia"},"common clothes|phb",{"item":"book|phb","displayName":"book of research notes"},"ink pen|phb","ink (1-ounce bottle)|phb",{"item":"oil (flask)|phb","displayName":"flask of oil (made from blubber)"},{"item":"acid (vial)|phb","displayName":"vial of acid (derived from digestive juices)"},{"special":"vial of fish scales"},{"special":"vial of seaweed"},{"special":"vial of jellyfish stingers"},{"special":"glass bottle of unidentified slime"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'arcana' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'medicine' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Simic Scientist' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Smuggler', (SELECT id FROM sources WHERE name ILIKE 'GoS' LIMIT 1), 34, false, false, '## Feature: Down Low
...
| d6 | Ideal |
|---|---|
| 1 | {@b Wealth} Heaps of coins in a secure vault is all I dream of. (Any) |
| 2 | {@b Smuggler''s Code} I uphold the unwritten rules of the smugglers, who do not cheat one another or directly harm innocents. (Lawful) |
| 3 | {@b All for a Coin} I''ll do nearly anything if it means I turn a profit. (Evil) |
| 4 | {@b Peace and Prosperity} I smuggle only to achieve a greater goal that benefits my community. (Good) |
| 5 | {@b People} For all my many lies, I place a high value on friendship. (Any) |
| 6 | {@b Daring} I am most happy when risking everything. (Any) |
| d6 | Bond |
|---|---|
...
| 6 | Though I act charming, I feel nothing for others and don''t know what friendship is. |', '[{"a":[{"special":"fancy leather vest"}],"b":[{"special":"pair of leather boots"}]},{"_":["common clothes|phb",{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Smuggler' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (water)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Soldier', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 140, false, true, '## Feature: Military Rank
...
| 6 | I''d rather eat my armor than admit when I''m wrong. |', '[{"_":[{"special":"insignia of rank"},{"special":"trophy taken from a fallen enemy (a dagger, broken blade, or piece of a banner)"},"common clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":[{"item":"dice set|phb","displayName":"bone dice set"}],"b":["playing card set|phb"]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'intimidation' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Soldier' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (land)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Stojanow Prisoner', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 8, false, false, '## Lifestyle
Poor
...
| 6 | The ghosts from my past hinder my actions. |', '[{"_":[{"special":"small knife"},"common clothes|phb",{"item":"trinket|phb","displayName":"trinket from the life you stayed behind to defend"},{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyGamingSet' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Stojanow Prisoner' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Ticklebelly Nomad', (SELECT id FROM sources WHERE name ILIKE 'ALCurseOfStrahd' LIMIT 1), 9, false, false, '## Lifestyle
Poor
...
| 6 | My lack of worldliness often proves my undoing in social, commercial, and hostile situations. |', '[{"_":["herbalism kit|phb",{"special":"small article of jewelry that is distinct to your tribe"},"hunting trap|phb","common clothes|phb",{"item":"pouch|phb","containsValue":500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'animal handling' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'giant' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Ticklebelly Nomad' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Trade Sheriff', (SELECT id FROM sources WHERE name ILIKE 'ALRageOfDemons' LIMIT 1), 11, false, false, '## Lifestyle
Modest
...
| 6 | I speak for the First Lord of Hillsfar and make sure everyone knows it. |', '[{"_":["thieves'' tools|phb",{"special":"gray cloak"},{"item":"fine clothes|phb","displayName":"Sheriff''s insignia (badge) a set of fine clothes"},{"value":1700}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'elvish' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Trade Sheriff' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Urban Bounty Hunter', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 153, false, false, '## Feature: Ear to the Ground
...
For instance, your bond might involve other bounty hunters or the organizations or individuals that employ you. Your ideal could be associated with your determination always to catch your quarry or your desire to maintain your reputation for being dependable.', '[{"_":[{"item":"pouch|phb","containsValue":2000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 2);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urban Bounty Hunter' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), TRUE, 2);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Urchin', (SELECT id FROM sources WHERE name ILIKE 'PHB' LIMIT 1), 141, false, false, '## Feature: City Secrets
...
| 6 | People who can''t take care of themselves get what they deserve. |', '[{"_":[{"special":"small knife"},{"special":"map of the city you grew up in"},{"special":"pet mouse"},{"special":"token to remember your parents by"},"common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Urchin' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'thieves'' tools' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Uthgardt Tribe Member', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 153, false, false, '## Feature: Uthgardt Heritage
...
Your bond is undoubtedly associated with your tribe or some aspect of Uthgardt philosophy or culture (perhaps even Uthgar himself). Your ideal is a personal choice that probably hews closely to the ethos of your people and certainly doesn''t contradict or compromise what being an Uthgardt stands for.', '[{"_":["hunting trap|phb","traveler''s clothes|phb",{"item":"pouch|phb","containsValue":1000}]},{"a":[{"special":"totemic token"}],"b":[{"special":"set of tattoos marking your loyalty to Uthgar and your tribal totem"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Uthgardt Tribe Member' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Variant City Watch (Investigator)', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 145, false, false, '## Feature: Watcher''s Eye
Your experience in enforcing the law, and dealing with lawbreakers, gives you a feel for local laws and criminals. You can easily find the local outpost of the watch or a similar organization, and just as easily pick out the dens of criminal activity in a community, although you''re more likely to be welcome in the former locations rather than the latter.
...
INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'insight' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'investigation' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Variant City Watch (Investigator)' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 2);

-- Variant Clasp Member (Myriad Operative) is a copy of Clasp Member and is handled manually or by another script.

-- Variant Criminal (Spy) is a copy of Criminal and is handled manually or by another script.

-- Variant Entertainer (Gladiator) is a copy of Entertainer and is handled manually or by another script.

-- Variant Guild Artisan (Guild Merchant) is a copy of Guild Artisan and is handled manually or by another script.

-- Variant Noble (Knight) is a copy of Noble and is handled manually or by another script.

-- Variant Noble (Retainers) is a copy of Noble and is handled manually or by another script.

-- Variant Sailor (Pirate) is a copy of Sailor and is handled manually or by another script.

-- Variant Whitestone Rifle Corps (Grey Hunter) is a copy of Whitestone Rifle Corps and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Vizier', (SELECT id FROM sources WHERE name ILIKE 'PSA' LIMIT 1), 10, false, false, '## Feature: Voice of Authority
...
| d6 | Ideal |
|---|---|
| 1 | {@b Solidarity.} The worthy must respect the worthy. In the afterlife, all will be united in goal and action. (Oketra) |
| 2 | {@b Knowledge.} The worthy shall cultivate a nimble mind, so as to perceive the wonders beyond imagination that wait in the afterlife. (Kefnet) |
| 3 | {@b Strength.} The worthy shall hone a strong body that can withstand the boundless energies of the afterlife. (Rhonas) |
| 4 | {@b Ambition.} The worthy shall strive for greatness, for supremacy in life leads to supremacy in the afterlife. (Bontu) |
| 5 | {@b Zeal.} The worthy shall rush to the God-Pharaoh''s side with relentless passion, rising to overcome every obstacle in their way. (Hazoret) |
| 6 | {@b Naktamun.} The life of the city is ordered according to the plan of the God-Pharaoh, and that order must be preserved at all costs. |
| d6 | Bond |
|---|---|
...
| 6 | I secretly believe the God-Pharaoh''s return will not bring blessing to this world. |', '[{"a":[{"equipmentType":"toolArtisan"}],"b":[{"equipmentType":"instrumentMusical"}]},{"_":[{"special":"scroll of your god''s teachings"},{"special":"vizier''s cartouche"},"fine clothes|phb",{"item":"pouch|phb","containsValue":2500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'religion' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyArtisansTool' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Vizier' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'anyMusicalInstrument' LIMIT 1), FALSE);

-- Vizier (Dissenter) is a copy of Vizier and is handled manually or by another script.

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Volstrucker Agent', (SELECT id FROM sources WHERE name ILIKE 'EGW' LIMIT 1), 202, false, false, '## Feature: Shadow Network
...
| 4 | Fear is a powerful motivator. I will do whatever it takes to prevent those who know what I am from seeing me fail, and from those I care about from knowing what I am. |', '[{"_":["common clothes|phb",{"special":"black cloak with a hood"},"poisoner''s kit|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'deception' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'stealth' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Volstrucker Agent' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'poisoner''s kit' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Waterdhavian Noble', (SELECT id FROM sources WHERE name ILIKE 'SCAG' LIMIT 1), 154, false, false, '## Feature: Kept in Style
...
Like other nobles, you were born and raised in a different world from the one that most folk know - one that grants you privilege but also calls you to fulfill a duty befitting your station. Your bond might be associated with your family alone, or it could be concerned with another noble house that sides with or opposes your own. Your ideal depends to some extent on how you view your role in the family, and how you intend to conduct yourself in the world at large as a representative of your house.', '[{"_":["fine clothes|phb",{"special":"scroll of pedigree"},{"special":"skin of fine zzar or wine"},{"special":"purse","containsValue":2000}]},{"a":["signet ring|phb"],"b":[{"special":"brooch"}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'history' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'persuasion' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'gaming set' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Waterdhavian Noble' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Whitestone Rifle Corps', (SELECT id FROM sources WHERE name ILIKE 'TDCSR' LIMIT 1), 187, false, false, '## Feature: Legacy of Secrecy
...
| 2 | I''m on an important mission to protect {@book Whitestone|TDCSR|3|Whitestone} or guard one of our allies. |
| 3 | {@book Whitestone|TDCSR|3|Whitestone} is in trouble, and I was sent away to seek help. |
...
| 6 | My weapon was stolen. I built a new one, but I can''t return home until I''ve tracked down the thief and recovered the original. ({@book Whitestone Hunter|TDCSR|3|Grey Hunters} variant only) |
...
| {@dice d6} | Ideal |
|---|---|
| 1 | {@b Responsibility}. I have a duty to protect the people of {@book Whitestone|TDCSR|3|Whitestone} and to uphold the trust placed in me by the de Rolos. (Lawful) |
| 2 | {@b Militarization}. Everyone should have access to the most powerful weapons available, so they can defend themselves effectively. (Evil) |
| 3 | {@b Cooperation}. Any problem can be solved as long as people are willing to work together. (Good) |
| 4 | {@b Camaraderie}. It''s important to have people you can trust to help out in a fight—and to uncork a bottle together afterward. (Any) |
| 5 | {@b Context}. There are no universal rights or wrongs. Every choice depends on the details of the situation. (Chaotic) |
| 6 | {@b Secrecy}. Information is valuable, but it can also be dangerous. I''ll keep my mouth shut and gather as much intel as I can. (Neutral) |
| {@dice d6} | Bond |
|---|---|
...
| 3 | {@book Whitestone|TDCSR|3|Whitestone} is the best city in all of Tal''Dorei. Nowhere else has been blessed by the {@deity The Dawnfather|Exandria|TDCSR|Dawnfather} and has a clock that tracks the movement of the stars! |
...
| 6 | The people of {@book Whitestone|TDCSR|3|Whitestone} cared for my family when we had nothing. I promise to repay their compassion with my service. |
| {@dice d6} | Flaw |
|---|---|
...
| 6 | The first and only time I killed someone, it changed my life. I still dream about it, and I''ll never be the carefree person I was before. |', '[{"a":["musket|dmg"],"b":["pistol|dmg"]},{"_":["common clothes|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'perception' LIMIT 1), TRUE, 2);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), TRUE, 2);

INSERT INTO background_language_proficiencies (background_id, language_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Whitestone Rifle Corps' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Wildspacer', (SELECT id FROM sources WHERE name ILIKE 'AAG' LIMIT 1), 8, false, false, '## Close Encounter
...
|---|---|
| 1 | {@creature Beholder} |
| 2 | {@creature Cosmic horror|BAM}* |
| 3 | {@creature Feyr|BAM}* |
| 4 | {@filter Lunar dragon|bestiary|source=BAM|search=lunar dragon}* |
| 5 | {@creature Mind flayer} |
| 6 | {@creature Neh-thalggu|BAM}* |
| 7 | {@creature Neogi|MPMM}* |
| 8 | {@creature Space clown|BAM}* |
| 9 | {@creature Vampirate|BAM}* |
| 10 | {@creature Void scavver|BAM}* |

## Feature: Wildspace Adaptation
You gain the {@feat Tough||Tough feat} from the {@book Player''s Handbook|PHB}. In addition, you learned how to adapt to zero gravity. Being weightless doesn''t give you disadvantage on any of your melee attack rolls (see "{@book Weightlessness|AAG|2|Weightlessness}" in {@book chapter 2|AAG|2}).', '[{"_":[{"item":"club|phb","displayName":"belaying pin"},"traveler''s clothes|phb","grappling hook|phb","hempen rope (50 feet)|phb",{"item":"pouch|phb","containsValue":1000}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'athletics' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'navigator''s tools' LIMIT 1), FALSE);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Wildspacer' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'vehicles (space)' LIMIT 1), FALSE);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Witchlight Hand', (SELECT id FROM sources WHERE name ILIKE 'WBtW' LIMIT 1), 11, false, false, '## Feature: Carnival Fixture
...
| 6 | Old {@creature blink dog} |
| 7 | Cheery {@creature sprite} |
...
| 6 | I never give away anything for free and always expect something in return. |
| 7 | I have many vices and tend to indulge them. |
| 8 | I''m always changing my mind—well, almost always. |', '[{"a":["disguise kit|phb"],"b":[{"equipmentType":"instrumentMusical"}]},{"_":[{"special":"deck of cards"},"costume clothes|phb","feywild trinket|wbtw",{"item":"pouch|phb","containsValue":800}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'performance' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'sleight of hand' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'disguise kit' LIMIT 1), TRUE, 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice, choose_count) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witchlight Hand' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'musical instrument' LIMIT 1), TRUE, 1);

INSERT INTO backgrounds (name, source_id, page, srd, basic_rules, description, starting_equipment) VALUES ('Witherbloom Student', (SELECT id FROM sources WHERE name ILIKE 'SCC' LIMIT 1), 36, false, false, '## Feature: Witherbloom Initiate
...
| Spell Level | Spells |
|---|---|
| 1st | {@spell Cure Wounds}, {@spell Inflict Wounds} |
| 2nd | {@spell Lesser Restoration}, {@spell Wither and Bloom|SCC} |
| 3rd | {@spell Revivify}, {@spell Vampiric Touch} |
| 4th | {@spell Blight}, {@spell Death Ward} |
| 5th | {@spell Antilife Shell}, {@spell Greater Restoration} |
...
When you make your character, you may roll once on the {@item Witherbloom Trinket|SCC|Witherbloom Trinkets} table, instead of on the {@item trinket|phb|Trinkets table} in the {@book Player''s Handbook|PHB}, for your starting trinket.', '[{"_":["ink (1-ounce bottle)|phb","ink pen|phb",{"special":"book about plant identification"},"iron pot|phb","herbalism kit|phb",{"special":"school uniform"},{"item":"pouch|phb","containsValue":1500}]}]');

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'nature' LIMIT 1), FALSE);

INSERT INTO background_skill_proficiencies (background_id, skill_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student' LIMIT 1), (SELECT id FROM skills WHERE name ILIKE 'survival' LIMIT 1), FALSE);

INSERT INTO background_language_proficiencies (background_id, language_id,any_standard) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student' LIMIT 1), (SELECT id FROM languages WHERE name ILIKE 'any' LIMIT 1), 1);

INSERT INTO background_tool_proficiencies (background_id, tool_id, is_choice) VALUES ((SELECT id FROM backgrounds WHERE name = 'Witherbloom Student' LIMIT 1), (SELECT id FROM tools WHERE name ILIKE 'herbalism kit' LIMIT 1), FALSE);